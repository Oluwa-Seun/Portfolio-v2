...
<div class="container">
  <div class="row" style="margin-bottom: 100px">
    <div class="col-sm-8 align-self-center">
      <div class="mt-custom">
        <h3 class="display-3">I Design & 🚀 Build SoftWare products that make's lives <b>easier.!</b></h3>
        <a href="mailto:oluwaseunolubiyione@gmail.com" target="_blank">
  ...
  <div class="row" style="background-color: #FFB037; border-radius: 20px; margin-bottom: 100px;">
    ...
    <div class="col-sm-6 align-self-center order-first p-4">
      <div class="text-center">
        <img src="../assets/me.png" class="img-fluid rounded" width="421" height="421" alt="Oluwaseun Image">
      </div>
    </div>
  </div>
